...
def createMail(header,data='',attachments=''):
    ...
    return mail
def sendMail(toWho,fromWho='',mailBody='',serv='smtp.ym.163.com',usr='integration',passwd='123456'):
