...
def createMail(header,data='',attachments=''):
    ...
    return mail
def sendMail(toWho,fromWho='',mailBody='',serv='smtp.mxhichina.com',usr='integration@acuteangle.com',passwd='Hello1234'):
...
if __name__=='__main__':
     ...
     header = { 'from' : 'integration@acuteangle.com' , 'to' : 'test@acuteangle.cn' ,'cc' : 'cc@acuteangle.cn','subject' : 'email test' }
	...
	attach = ['/home/likewise-open/SAGEMWIRELESS/92940/sw_download/buglist_resolved.txt']
     ...
     server=SMTPconnect('smtp.mxhichina.com','integration@acuteangle.com','Hello1234') 
     receivers=[] # receive mail persons
     receivers=['yiweicheng@acuteangle.cn','luolaigang@acuteangle.com']
     server.sendmail(['integration@acuteangle.com'],receivers,mail)
     server.quit() 
